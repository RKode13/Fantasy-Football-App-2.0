...
const ENABLE_LOCAL_ADP_SAMPLE_TEST=false;
if(typeof window!=="undefined" && ENABLE_LOCAL_ADP_SAMPLE_TEST && !window.EXTERNAL_ADP_PAYLOAD){
  window.EXTERNAL_ADP_PAYLOAD={
    records:[
      {id:1, adp:2.4},
      {name:"Christian McCaffrey", team:"SF", pos:"RB", adp:9.8},
      {name:"CeeDee Lamb", team:"DAL", pos:"WR", adp:4.6}
    ]
  };
}
